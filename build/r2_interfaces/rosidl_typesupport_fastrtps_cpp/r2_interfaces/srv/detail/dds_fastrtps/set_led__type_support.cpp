...
#include "r2_interfaces/srv/detail/set_led__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const r2_interfaces::srv::SetLed_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  r2_interfaces::srv::SetLed_Request & ros_message)
{
  // Member: led_number
  cdr >> ros_message.led_number;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = r2_interfaces::srv::SetLed_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const r2_interfaces::srv::SetLed_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<r2_interfaces::srv::SetLed_Request *>(
    untyped_ros_message);
...
{
  return &r2_interfaces::srv::typesupport_fastrtps_cpp::_SetLed_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, r2_interfaces, srv, SetLed_Request)() {
  return &r2_interfaces::srv::typesupport_fastrtps_cpp::_SetLed_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_r2_interfaces
cdr_serialize(
  const r2_interfaces::srv::SetLed_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  r2_interfaces::srv::SetLed_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = r2_interfaces::srv::SetLed_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const r2_interfaces::srv::SetLed_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<r2_interfaces::srv::SetLed_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &r2_interfaces::srv::typesupport_fastrtps_cpp::_SetLed_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, r2_interfaces, srv, SetLed_Response)() {
  return &r2_interfaces::srv::typesupport_fastrtps_cpp::_SetLed_Response__handle;
}
...
{
  return &r2_interfaces::srv::typesupport_fastrtps_cpp::_SetLed__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, r2_interfaces, srv, SetLed)() {
  return &r2_interfaces::srv::typesupport_fastrtps_cpp::_SetLed__handle;
}
