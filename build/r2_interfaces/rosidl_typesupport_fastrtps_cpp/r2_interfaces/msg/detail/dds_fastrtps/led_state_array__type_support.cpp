...
#include "r2_interfaces/msg/detail/led_state_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const r2_interfaces::msg::LedStateArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  r2_interfaces::msg::LedStateArray & ros_message)
{
  // Member: led_states
  {
    cdr >> ros_message.led_states;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = r2_interfaces::msg::LedStateArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const r2_interfaces::msg::LedStateArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<r2_interfaces::msg::LedStateArray *>(
    untyped_ros_message);
...
get_message_type_support_handle<r2_interfaces::msg::LedStateArray>()
{
  return &r2_interfaces::msg::typesupport_fastrtps_cpp::_LedStateArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, r2_interfaces, msg, LedStateArray)() {
  return &r2_interfaces::msg::typesupport_fastrtps_cpp::_LedStateArray__handle;
}
