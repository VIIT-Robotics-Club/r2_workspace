...
class Metaclass_SetLed(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from r2_interfaces.srv import _set_led
...
class SetLed(metaclass=Metaclass_SetLed):
    from r2_interfaces.srv._set_led import SetLed_Request as Request
    from r2_interfaces.srv._set_led import SetLed_Response as Response
