...
class Metaclass_CountUntil_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('r2_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'r2_interfaces.action.CountUntil_Goal')
            logger.debug(
...
class Metaclass_CountUntil_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'r2_interfaces.action.CountUntil_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_CountUntil_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'r2_interfaces.action.CountUntil_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_CountUntil_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from r2_interfaces.action import CountUntil
...
class CountUntil_SendGoal_Request(metaclass=Metaclass_CountUntil_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'r2_interfaces/CountUntil_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['r2_interfaces', 'action'], 'CountUntil_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from r2_interfaces.action._count_until import CountUntil_Goal
...
class Metaclass_CountUntil_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'r2_interfaces.action.CountUntil_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from r2_interfaces.action import _count_until
...
class CountUntil_SendGoal(metaclass=Metaclass_CountUntil_SendGoal):
    from r2_interfaces.action._count_until import CountUntil_SendGoal_Request as Request
    from r2_interfaces.action._count_until import CountUntil_SendGoal_Response as Response
...
class CountUntil_GetResult_Response(metaclass=Metaclass_CountUntil_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'r2_interfaces/CountUntil_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['r2_interfaces', 'action'], 'CountUntil_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from r2_interfaces.action._count_until import CountUntil_Result
...
class Metaclass_CountUntil_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'r2_interfaces.action.CountUntil_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class CountUntil_GetResult(metaclass=Metaclass_CountUntil_GetResult):
    from r2_interfaces.action._count_until import CountUntil_GetResult_Request as Request
    from r2_interfaces.action._count_until import CountUntil_GetResult_Response as Response
...
class Metaclass_CountUntil_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'r2_interfaces.action.CountUntil_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class CountUntil_FeedbackMessage(metaclass=Metaclass_CountUntil_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'r2_interfaces/CountUntil_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['r2_interfaces', 'action'], 'CountUntil_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from r2_interfaces.action._count_until import CountUntil_Feedback
...
class Metaclass_CountUntil(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'r2_interfaces.action.CountUntil')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class CountUntil(metaclass=Metaclass_CountUntil):
    ...
    from r2_interfaces.action._count_until import CountUntil_Goal as Goal
    # The result message defined in the action definition.
    from r2_interfaces.action._count_until import CountUntil_Result as Result
    # The feedback message defined in the action definition.
    from r2_interfaces.action._count_until import CountUntil_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from r2_interfaces.action._count_until import CountUntil_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from r2_interfaces.action._count_until import CountUntil_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from r2_interfaces.action._count_until import CountUntil_FeedbackMessage as FeedbackMessage
